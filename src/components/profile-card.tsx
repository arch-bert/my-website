...
export default function ProfileCard() {
  return (
    <div className="flex flex-col p-6 items-center md:w-[400px] xl:w-[500px] rounded-3xl bg-secondary my-shadow outline outline-4 outline-tertiary my-shadow hover:outline-white hover:scale-[1.05] hover:shadow-none transition-all duration-500 ease-in-out">
