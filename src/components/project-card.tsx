    ...
    <div className="pt-12">
      <div className="flex flex-row h-[300px] px-4 pt-4 rounded-xl bg-secondary outline outline-1 outline-gray-600 shadow-[5px_7px_10px_rgba(255,255,255,0.3)]">
        ...
        <div className="flex flex-col h-full">
          <h1 className="text-4xl pb-2">Card Counting Simulator</h1>
          {/* Image with max height set */}
          <img src="simulation.png" alt="Code" className="max-h-full object-contain rounded-xl" />
        </div>
        <div className="flex flex-col h-full w-1/2">
          ...
          <div className="text-right">
            <button className="w-fit p-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg">
              View Project
            </button>
          </div>
        </div>
