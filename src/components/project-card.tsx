...
export default function ProjectCard() {
  return (
      <BackgroundGradient animate={false}>
        <div className="flex flex-row p-7 rounded-3xl bg-secondary">
          ...
          <div className="flex flex-col justify-between pl-4 relative">
            ...
            <div className="flex-grow mt-20">
              <p className="text-white">
                ...
                Voluptates similique doloremque atque et dolor itaque, blanditiis
                minus debitis neque voluptas optio rerum pariatur provident quia
                asperiores nam commodi aperiam corporis.
              </p>
            </div>
            <div className="text-right mt-4">
              <button className="w-fit px-4 py-2 my-button">View Project</button>
            </div>
          </div>
        </div>
      </BackgroundGradient>
