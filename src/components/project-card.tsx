...
export default function ProjectCard() {
  return (
    <div className="flex flex-row h-auto p-7 my-10 mx-40 rounded-xl bg-secondary outline outline-1 outline-gray-600 shadow-lg transition-transform duration-300 ease-in-out hover:scale-105">
